...
> = {
  default: {
    outer: "bg-gradient-to-b from-[#86868B]/40 to-[#E8E8ED]",
    inner: "bg-gradient-to-b from-[#FAFAFA] via-[#D1D1D6] to-[#E5E5E5]",
    button: "bg-gradient-to-b from-[#F5F5F7] to-[#E8E8ED]",
    textColor: "text-[#1D1D1F]",
    textShadow: "",
  },
  primary: {
    outer: "bg-gradient-to-b from-[#0066CC] to-[#3b82f6]",
    inner: "bg-gradient-to-b from-[#0066CC] via-[#0077ED] to-[#3b82f6]",
    button: "bg-gradient-to-b from-[#0066CC] to-[#0055A5]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgba(0,0,0,0.2)]",
  },
  success: {
    outer: "bg-gradient-to-b from-[#008855] to-[#7CCB9B]",
    inner: "bg-gradient-to-b from-[#E5F8F0] via-[#006633] to-[#D1F0E6]",
  ...
  gold: {
    outer: "bg-gradient-to-b from-[#D4AF37] to-[#EAD98F]",
    inner: "bg-gradient-to-b from-[#FFFDDD] via-[#AA7C11] to-[#FFF1B3]",
    button: "bg-gradient-to-b from-[#F39C12] to-[#D35400]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgba(0,0,0,0.2)]",
  },
  bronze: {
    ...
    button: "bg-gradient-to-b from-[#CD7F32] to-[#A0522D]",
