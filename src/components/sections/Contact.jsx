  ...
  return (
    <div className="flex items-center gap-5 p-5 rounded-3xl border border-slate-200/60 dark:border-zinc-800/60 bg-[#F5F5F7]/85 dark:bg-zinc-900/85 backdrop-blur-md shadow-sm hover:border-slate-300 dark:hover:border-zinc-700 transition-all duration-200">
      ...
      <div className="flex flex-col">
        <span className="text-[10px] font-mono text-slate-400 dark:text-zinc-550 uppercase tracking-widest font-semibold">{label}</span>
    ...
    <section id="contact" ref={ref} className="py-32 relative bg-white dark:bg-[#0B0B0C] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-start">
        ...
        <motion.form
          ...
          className="rounded-3xl border border-slate-200/80 dark:border-zinc-800/80 bg-white/95 dark:bg-zinc-900/95 p-8 flex flex-col gap-5 shadow-lg shadow-slate-200/10 dark:shadow-none backdrop-blur-md"
        >
          {/* Row 1: Full Name */}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="bg-[#F5F5F7] dark:bg-zinc-950 border border-slate-200/60 dark:border-zinc-800 rounded-xl px-4 py-3.5 text-sm text-[#1D1D1F] dark:text-[#F5F5F7] placeholder-slate-400 dark:placeholder-zinc-650 outline-none resize-none transition-all duration-200 focus:border-[#0066cc]/50 focus:bg-white dark:focus:bg-zinc-900 focus:shadow-[0_0_20px_rgba(0,102,204,0.05)]"
            />
          </div>
