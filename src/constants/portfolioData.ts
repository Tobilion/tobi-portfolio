...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    desc: "An offline-first football simulation and prediction market: a real-time match engine drives live-shifting odds, single/accumulator slips, a same-game multi builder, mid-match cash-out, club ownership with a transfer market, and a 14-game casino suite — all client-side.",
    color: "#10b981",
  ...
  },
  {
    ...
    desc: "An offline command dispatcher and optional local AI coding assistant for managing multiple projects from one web UI — semantic intent matching (embeddings + fuzzy + NLP), a sandboxed tool-calling loop for AI mode (read/write/edit/search/git), git safety checkpoints before risky commands, and a self-tuning telemetry layer. Zero external API calls, everything stays on-device.",
    color: "#ec4899",
  ...
  },
  {
    ...
    desc: "An earlier, simpler 2D prototype of Dream Kick — a playable canvas-based football match with keyboard/touch controls, squad and tactics screens, built as the proof of concept before the game was rebuilt in 3D.",
    color: "#facc15",
