...
export const PROJECTS = [
  ...
  {
    title: "Aether — distributed message broker",
    tags: ["Go", "gRPC", "Protobuf", "Distributed Systems"],
    desc: "A lightweight, high-throughput distributed pub/sub broker built in Go with sub-millisecond delivery latency, dynamic partition rebalancing, and persistent append-only logs.",
    color: "#0ea5e9",
    githubUrl: "https://github.com/Tobilion/aether-grpc-broker",
    demoUrl: "",
  },
  {
